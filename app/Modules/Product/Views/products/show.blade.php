            ...
            <div class="product-layout">
                ...
                <div class="content-section">
                    ...
                    <div class="action-buttons">
                        <form action="{{ route('cart.add.product', $decoratedProduct->product->id) }}" method="POST"
                            id="addToCartForm">
                            @csrf
                    ...
                    <div class="additional-actions">
                        <button class="wishlist-btn" onclick="addToWishlist({{ $decoratedProduct->product->id }})">ADD TO
                            WISHLIST</button>
                        <a href="#" class="action-link" onclick="shareHint({{ $decoratedProduct->product->id }})">share a
                            hint</a>
                    </div>
                    ...
                    @foreach($recommendations as $recommendedProduct)
                        ...
                        <div class="recommendation-card">
                            <div class="card-image">
                                <img src="{{ $recommendedData['main_image'] ?: '/img/default-product.jpg' }}"
                                    alt="{{ $recommendedData['name'] }}">
                            </div>
                            <div class="card-content">
                                <h3 class="card-title">{{ $recommendedData['name'] }}</h3>
                                <div class="card-price">RM {{ number_format($recommendedData['display_price'], 2) }}</div>
                                <a href="{{ route('products.show', $recommendedProduct->product->id) }}"
