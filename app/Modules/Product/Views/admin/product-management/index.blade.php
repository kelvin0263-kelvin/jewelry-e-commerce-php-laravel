...
@section('content')
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0 opacity-75" style="font-size: 0.7rem;">Enhance products from inventory and publish them to customers</p>
                    </div>
                    <div class="d-flex gap-1">
                        <a href="{{ route('admin.product-management.create') }}" class="btn btn-light btn-sm">
    ...
    @endif
        ...
        <tbody>
                            @forelse ($products as $decoratedProduct)
                                @php
                                ...
                                <tr class="border-bottom hover-row">
                                    <td class="border-end py-1 px-2 align-middle text-center">
                                        <span class="text-dark" style="font-size: 0.7rem;">#{{ $data['id'] }}</span>
                                    </td>
                                    <td class="border-end py-1 px-2 align-middle text-center">
                                        <span class="text-dark" style="font-size: 0.7rem;">{{ $data['name'] }}</span>
                                    </td>
                                    <td class="border-end py-1 px-2 align-middle text-center">
                                        <span class="text-dark" style="font-size: 0.7rem;">RM{{ number_format($data['price'], 2) }}</span>
                                    </td>
                                    <td class="border-end py-1 px-2 align-middle text-center">
                                        <span class="badge bg-light text-dark border" style="font-size: 0.7rem;">{{ ucfirst($data['category']) }}</span>
                                    </td>
                                    <td class="border-end py-1 px-2 align-middle text-center">
                        ...
                        @endif
                                    ...
                                    <td class="border-end py-1 px-2 align-middle text-center">
                                        <span class="text-muted" style="font-size: 0.7rem;">{{ $data['publish_info']['published_by'] }}</span>
                                    </td>
                        ...
                        @endif
                                    ...
                                    <td class="py-1 px-2 align-middle text-center" style="width: 400px;">
                                        <div class="d-flex gap-1 flex-wrap justify-content-center">
                                            <a href="{{ route('admin.product-management.show', $product) }}" 
                                            ...
                                            @if($data['can_publish'])
                                                <form action="{{ route('admin.product-management.publish', $product) }}" method="POST" class="d-inline">
                                @csrf
                        ...
                        @endif
                                            ...
                                            @if($data['can_unpublish'])
                                                <form action="{{ route('admin.product-management.unpublish', $product) }}" method="POST" class="d-inline">
                                @csrf
                        ...
                        @endif
                                            ...
                                            @if($data['can_delete'])
                                                <form action="{{ route('admin.product-management.destroy', $product) }}" method="POST" class="d-inline"
                ...
                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p class="text-muted mb-4 fs-5">Start by creating your first product to get started</p>
                                            <a href="{{ route('admin.product-management.create') }}" class="btn btn-primary btn-lg shadow-sm">
        ...
        <div class="d-flex justify-content-center mt-3">
            <a href="{{ route('admin.reviews.index') }}" class="reviews-btn">
