            ...
            <div class="bg-white rounded-lg shadow-md">
                ...
                @else
                    ...
                    <div class="p-12 text-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('tickets.create') }}"
                                class="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center flex flex-col justify-center">
                        <div class=" rounded-lg p-4 mb-3">
                            <svg class="mx-auto h-8 w-8 text-blue-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-3.582 8-8 8a8.991 8.991 0 01-4.338-1.126L5 21l1.126-3.662A8.991 8.991 0 013 12c0-4.418 3.582-8 8-8s8 3.582 8 8z">
                                </path>
                            </svg>
                        </div>
                    ...
                    <div class="text-center">
                        <div class=" rounded-lg p-4 mb-3">
                            <svg class="mx-auto h-8 w-8 text-green-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                </path>
                    ...
                    <div class="text-center">
                        <div class=" rounded-lg p-4 mb-3">
                            <svg class="mx-auto h-8 w-8 text-purple-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
