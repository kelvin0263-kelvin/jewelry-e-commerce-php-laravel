                ...
                <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex gap-4">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="preferred_contact_method" value="phone"
                                        {{ old('preferred_contact_method') === 'phone' ? 'checked' : '' }} class="mr-2">
                                    Phone
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="preferred_contact_method" value="portal"
                                        {{ old('preferred_contact_method') === 'portal' ? 'checked' : '' }} class="mr-2">
                                    Customer Portal
                                </label>
                            </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @enderror
                            <p class="text-sm text-gray-500 mt-1">
                                Upload screenshots, documents, or other relevant files (max 5MB each, formats: jpg, png,
                                pdf, doc, docx, txt)
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                                ...
                                <a href="#" onclick="openChatWidget()"
                                    class="font-medium  hover:underline">
                                  For urgent issues, you can also a live chat  with our support team.
                                </a>
