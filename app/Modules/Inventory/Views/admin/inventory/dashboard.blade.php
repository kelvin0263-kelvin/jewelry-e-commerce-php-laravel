    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('admin.inventory.create') }}" class="group">
                <div
                    class="bg-white rounded-xl shadow hover:shadow-xl transition p-6 flex flex-col items-center justify-center text-center">
                    <img src="{{ asset('images/add-product.png') }}" alt="Add Product" class="w-20 h-20 mb-4">
                    <h2 class="text-lg font-semibold text-gray-800 group-hover:text-blue-600 transition">Create Inventory
                    </h2>
            ...
            <a href="{{ route('admin.inventory.index') }}" class="group">
                <div
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 group-hover:text-green-600 transition">Edit Inventory
                    </h2>
            ...
            <a href="{{ route('admin.inventory.list') }}" class="group">
                <div
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 group-hover:text-purple-600 transition">Inventory List
                    </h2>
