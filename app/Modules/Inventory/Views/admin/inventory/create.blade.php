                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" onchange="showTypeSpecificFields()" required
                                ...
                                <option value="NecklaceItem" {{ old('type') == 'NecklaceItem' ? 'selected' : '' }}>Necklace
                                </option>
                                <option value="EarringsItem" {{ old('type') == 'EarringsItem' ? 'selected' : '' }}>Earrings
                                </option>
                                <option value="BraceletItem" {{ old('type') == 'BraceletItem' ? 'selected' : '' }}>Bracelet
                                </option>
                            </select>
                            @error('type')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
