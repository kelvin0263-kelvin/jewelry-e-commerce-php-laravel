            ...
            <div id="variations-container" class="space-y-4">
                <div class="variation-item border p-4 rounded-lg shadow-sm">
                    <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                        ...
                        <input type="text" name="variations[0][size]" placeholder="Size" class="input-field">
                        <input type="text" name="variations[0][material]" placeholder="Material" class="input-field">
...
// Listen for input changes on stock fields
