...
@section('content')
  ...
  <nav
    ...
    <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
      ...
      <li class="relative flex items-center pr-2">
        ...
        <a href="javascript:;" class="block p-0 text-sm text-black transition-all ease-nav-brand" dropdown-trigger
        aria-expanded="false">
  ...
  <div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
      ...
      <div class="flex-auto p-4">
        <div>
        <canvas id="chart-line" height="400" data-labels='@json($labels)' data-data='@json($data)'
          data-label-name="Daily Revenue (RM)">
