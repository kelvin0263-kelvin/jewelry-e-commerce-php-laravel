                    ...
                    @foreach ($wishlistItems as $item)
                        <div class="wishlist-item" data-item-id="{{ $item->id }}">
                            ...
                            <div class="item-content">
                                ...
                                <div class="item-price">RM
                                    {{ number_format($item->product->discount_price ?? $item->product->price, 2) }}</div>
                                ...
                                <div class="item-actions">
                                    ...
                                    @if ($totalStock > 0)
                                        <form action="{{ route('cart.add.product', $item->product->id) }}" method="POST"
                                            class="inline add-to-cart-form"
                                            data-stock="{{ $item->variation->stock ?? ($item->inventory->quantity ?? 0) }}">
                                            @csrf
